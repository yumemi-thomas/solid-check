...
This branch restarts `@dom-expressions/jsx-compiler` as an AST-native compiler implemented with Oxc. The preserved string-splice research backend lives on local branch `research/oxc-string-backend`.
...
- `pnpm --filter @dom-expressions/jsx-compiler test`
- `pnpm --filter @dom-expressions/jsx-compiler lint`
