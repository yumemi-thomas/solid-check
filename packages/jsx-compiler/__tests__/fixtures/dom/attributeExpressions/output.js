...
var _tmpl$48 = /* @__PURE__ */ _$template(`<div><video muted></video><video></video><video></video><video defaultMuted></video><video></video><video src=test.mp4 muted>`);
var _tmpl$49 = /* @__PURE__ */ _$template(`<video src=test.mp4 muted>`);
var _tmpl$50 = /* @__PURE__ */ _$template(`<div class=todo>`);
var _tmpl$51 = /* @__PURE__ */ _$template(`<div class="todo item">`);
...
const template72 = _tmpl$41();
const template73 = _tmpl$43();
const template74 = _tmpl$44();
var _el$89 = _tmpl$41();
_el$89.poster = "1.jpg";
const template75 = _el$89;
var _el$90 = _tmpl$45();
var _el$91 = _el$90.firstChild;
_el$91.poster = "1.jpg";
...
const template78 = (() => {
	var _el$93 = _tmpl$4();
	_$setStyleProperty(_el$93, "width", props.width);
...
const template83 = (() => {
	var _el$98 = _tmpl$4();
	_$spread(_el$98, _$mergeProps(propsSpread, {
		get "data-dynamic"() {
			return color();
		},
		"data-static": color()
...
const template84 = (() => {
	var _el$99 = _tmpl$4();
	_$spread(_el$99, _$mergeProps(propsSpread1, propsSpread2, propsSpread3, {
		get "data-dynamic"() {
			return color();
		},
		"data-static": color()
...
const template87 = (() => {
	var _el$102 = _tmpl$46();
	_$effect(() => {
		return count();
	}, (_v$) => {
		_$setAttribute(_el$102, "aria-label", _v$);
	});
	_$style(_el$102, style);
	_$className(_el$102, style);
...
// Style edge cases from main
{
	(() => {
		var _el$104 = _tmpl$4();
		_$setStyleProperty(_el$104, "padding-left", `clamp(${1 + 1}px, ${1 + 1}px, ${1 + 1}px)`);
		return _el$104;
	})();
}
{
	(() => {
		var _el$105 = _tmpl$4();
		_$setStyleProperty(_el$105, "a", `clamp(${1 + 1}px, ${1 + 1}px, ${1 + 1}px)`);
		return _el$105;
	})();
}
{
	(() => {
		var _el$106 = _tmpl$4();
		_$style(_el$106, { [computedkey]: `clamp(${1 + 1}px, ${1 + 1}px, ${1 + 1}px)` });
		return _el$106;
	})();
}
{
...
var _el$109 = _tmpl$41();
_$setAttribute(_el$109, "something", { value: { value: 1 + 1 } });
const template91 = _el$109;
const template92 = _tmpl$47();
var _el$111 = _tmpl$48();
var _el$112 = _el$111.firstChild.nextSibling.nextSibling;
var _el$113 = _el$111.firstChild.nextSibling.nextSibling.nextSibling;
var _el$114 = _el$111.firstChild.nextSibling.nextSibling.nextSibling.nextSibling;
_$effect(() => {
...
var _el$116 = _tmpl$50();
_$effect(() => {
	return !!isActive();
}, (_v$) => {
	_el$116.classList.toggle("active", _v$);
});
const template94 = _el$116;
var _el$117 = _tmpl$4();
_$effect(() => {
...
const template98 = _el$120;
var _el$121 = _tmpl$51();
_$effect(() => {
	return !!isActive();
}, (_v$) => {
	_el$121.classList.toggle("active", _v$);
});
const template99 = _el$121;
