# Solid Checker for Zed

This private Zed extension registers `solid-checkerd` for JavaScript, JSX,
...
4. Select `packages/zed-solid-checker`.

When a project installs `solid-checker`, the extension automatically uses
`node_modules/.bin/solid-checkerd`. An explicit binary configuration takes
precedence:
