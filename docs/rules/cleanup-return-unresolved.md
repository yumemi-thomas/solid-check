...
resolved statically, so solid-checker cannot prove it is a valid cleanup value.
...
shape cannot be determined, solid-checker can neither certify the callback nor prove
